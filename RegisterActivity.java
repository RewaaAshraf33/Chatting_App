    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //غير كدا هيعمل كول للميثود ريجيستر ناو
                        ...
                        if (task.isSuccessful()) {
                          ...
                          FirebaseUser firebaseUser = auth.getCurrentUser();
                            ...
                            myref = FirebaseDatabase.getInstance().getReference("MyUsers")
                                    .child(userid);
                            //HashMaps .. بتربط بين قيمتين الكي والفاليو
                            HashMap<String, String> hashMap = new HashMap<>();
                            hashMap.put("id", userid);
                            hashMap.put("username", username);
                            hashMap.put("imageURL", "default");
                            //opening the mainActivity after success registration  هسمح لليوزر انه يدخل في الاكتيفيتي
                            myref.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    else{ Toast.makeText(RegisterActivity.this, "update failed", Toast.LENGTH_SHORT).show();}
                                }
                           });
